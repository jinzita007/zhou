      ...
      <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full"
            ...
            <div class="x-panel-top" xid="top1"> 
              <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="titleBar1"> 
                <div class="x-titlebar-left" xid="div6"> 
                  <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-top" icon="glyphicon glyphicon-qrcode"> 
                ...
                <div class="x-titlebar-title tb-searchBox" xid="div1" bind-click="searchBtnClick"> 
                  ...
                  <span><![CDATA[社区电商]]></span>  
                  <div /> 
                </div>  
                <div class="x-titlebar-right reverse" xid="div5"> 
                  <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-top" xid="button8" icon="icon-ios7-chatbubble"> 
                        ...
                        <tr xid="tr1"> 
                          <td bind-click="openPageClick" pagename="./list.w"
                            ...
                            <div class="text-center" xid="div2"> 
                              ...
                              <span xid="span7"><![CDATA[本地生活]]></span> 
                            </div> 
                          </td>  
                          <td bind-click="openPageClick" pagename="./list.w"
                            xid="td2"> 
                            <div class="text-center" xid="div3"> 
                              <img src="./main/img/02.png" alt="" xid="image1"
                                class="img-responsive center-block tb-img5"/>  
                              <span xid="span9"><![CDATA[社区综合]]></span> 
                            </div> 
                          </td>  
                          <td bind-click="openPageClick" pagename="./list.w"
                            xid="td3"> 
                            <div class="text-center" xid="div4"> 
                              <img src="./main/img/03.png" alt="" xid="image2"
                                class="img-responsive center-block tb-img5"/>  
                              <span xid="span10"><![CDATA[上门服务]]></span> 
                            </div> 
                          </td>  
                          <td bind-click="openPageClick" pagename="./list.w"
                            xid="td4"> 
                            <div class="text-center" xid="div7"> 
                              <img alt="" xid="image8" src="./main/img/04.png"
                                class="img-responsive center-block tb-img5"/>  
                              <span xid="span11"><![CDATA[健康服务]]></span> 
                            </div> 
                          </td>  
                          <td bind-click="openPageClick" pagename="./list.w"
                            xid="td5"> 
                            <div class="text-center" xid="div8"> 
                              <img alt="" xid="image9" src="./main/img/05.png"
                                class="img-responsive center-block tb-img5"/>  
                              <span xid="span12"><![CDATA[三旗推荐]]></span> 
                            </div> 
                          </td> 
                        </tr>  
                        <tr xid="tr2"> 
                          <td bind-click="openPageClick" pagename="./list.w"
                            ...
                            <div class="text-center" xid="div2"> 
                              <img alt="" xid="image3" src="./main/img/06.png"
                                class="img-responsive center-block tb-img5"/>  
                              <span xid="span19"><![CDATA[社区美图]]></span> 
                            </div> 
                          </td>  
                          <td bind-click="openPageClick" pagename="./list.w"
                            xid="td7"> 
                            <div class="text-center" xid="div3"> 
                              <img alt="" xid="image1" src="./main/img/07.png"
                                class="img-responsive center-block tb-img5"/>  
                              <span xid="span20"><![CDATA[社区生活]]></span> 
                            </div> 
                          </td>  
                          <td bind-click="openPageClick" pagename="./list.w"
                            xid="td8"> 
                            <div class="text-center" xid="div4"> 
                              <img alt="" xid="image2" src="./main/img/08.png"
                                class="img-responsive center-block tb-img5"/>  
                              <span xid="span10"><![CDATA[社区文化]]></span> 
                            </div> 
                          </td>  
                          <td bind-click="openPageClick" pagename="./list.w"
                            xid="td9"> 
                            <div class="text-center" xid="div7"> 
                              <img alt="" xid="image8" src="./main/img/09.png"
                                class="img-responsive center-block tb-img5"/>  
                              <span xid="span11"><![CDATA[社区视频]]></span> 
                            </div> 
                          </td>  
                 ...
                 <!-- <div component="$UI/system/components/justep/panel/panel"
                    ...
                    <div component="$UI/system/components/bootstrap/row/row"
                      ...
                      <div class="col cell col-xs-5 tb-nopadding" xid="col1"> 
                        <img src="./main/img/pic1.jpg" alt="" xid="image4"
                      ...
                      <div class="col cell col-xs-7 tb-nopadding" xid="col2"> 
                        <div component="$UI/system/components/bootstrap/row/row"
                          ...
                          <div class="col cell col-xs-12 tb-nopadding" xid="col5"> 
                            <img src="./main/img/pic2.jpg" alt="" xid="image5" class=" img-responsive center-block"
                        ...
                        <div component="$UI/system/components/bootstrap/row/row"
                          ...
                          <div class="col cell col-xs-6 tb-nopadding" xid="col8"> 
                            <img src="./main/img/pic3.jpg" alt="" xid="image6" class=" img-responsive center-block"
                              bind-click="openPageClick" pagename="./list.w"/> 
                          </div>  
                          <div class="col cell col-xs-6 tb-nopadding" xid="col9"> 
                            <img src="./main/img/pic4.jpg" alt="" xid="image7" class=" img-responsive center-block"
                              bind-click="openPageClick" pagename="./list.w"/> 
                          </div> 
                        </div> 
                      </div> 
                  ...
                  <!-- <div component="$UI/system/components/justep/panel/panel"
                    ...
                    <div component="$UI/system/components/bootstrap/row/row"
                      ...
                      <div class="col cell col-xs-6 tb-nopadding tb-line-right"
                        xid="col17"> 
                        <img src="./main/img/pic5.jpg" alt="" xid="image11"
                      ...
                      <div class="col cell col-xs-2 tb-nopadding tb-line-right"
                        xid="col18"> 
                        <img src="./main/img/pic6.jpg" alt="" xid="image14"
                          class=" img-responsive center-block tb-img6" bind-click="openPageClick"
                          pagename="./list.w" style="width:100%;"/> 
                      </div>  
                      <div class="col cell col-xs-2 tb-nopadding tb-line-right"
                        xid="col21"> 
                        <img src="./main/img/pic7.jpg" alt="" xid="image15"
                          class=" img-responsive center-block tb-img6" bind-click="openPageClick"
                          pagename="./list.w" style="width:100%;"/> 
                      </div>  
                      <div class="col cell col-xs-2 tb-nopadding" xid="col22"> 
                        <img src="./main/img/pic8.jpg" alt="" xid="image16"
                          class=" img-responsive center-block tb-img6" bind-click="openPageClick"
                          pagename="./list.w" style="width:100%;"/> 
                      </div> 
                    </div> 
        ...
        <div class="x-contents-content x-cards" xid="microContent"> 
          <div component="$UI/system/components/justep/windowContainer/windowContainer"
            class="x-window-container" xid="microContainer" src="./micro.w" autoLoad="true"/> 
        </div>  
        <div class="x-contents-content x-cards" xid="foundContent"> 
          <div component="$UI/system/components/justep/windowContainer/windowContainer"
            class="x-window-container" xid="foundContainer" src="./found.w" autoLoad="true"/> 
        </div>  
        <div class="x-contents-content x-cards" xid="shoppingContent" onInactive="shoppingContentInactive"> 
          <div component="$UI/system/components/justep/windowContainer/windowContainer"
            class="x-window-container" xid="shoppingContainer" src='./cart.w' autoLoad="true"/> 
        </div>  
        <div class="x-contents-content x-cards" xid="userContent"> 
          <div component="$UI/system/components/justep/windowContainer/windowContainer"
            class="x-window-container" xid="userContainer" src="./user.w" autoLoad="true"/> 
        </div> 
      </div> 
    </div>  
    <div class="x-panel-bottom" xid="bottom1" height="55"> 
      <div component="$UI/system/components/justep/button/buttonGroup" class="btn-group btn-group-justified x-card"
        ...
        <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-top"
          label="商品分类" xid="microBtn" icon="icon-radio-waves" target="microContent"> 
          <i xid="i2" class="icon-radio-waves icon"/>  
          <span xid="span2">商品分类</span> 
        </a>  
        <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-top"
